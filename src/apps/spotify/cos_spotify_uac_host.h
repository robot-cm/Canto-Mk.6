/**
 * @file cos_spotify_uac_host.h
 * @brief USB Audio Class (UAC) Host 类驱动 —— 供 cos_spotify_uac.c 使用。
 *
 ...
 */
#ifndef COS_SPOTIFY_UAC_HOST_H
#define COS_SPOTIFY_UAC_HOST_H
...
#define COS_SPOTIFY_UAC_TX_BUF_SIZE   1024
