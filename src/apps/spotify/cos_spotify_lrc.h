 ...
 */
#ifndef COS_SPOTIFY_LRC_H
#define COS_SPOTIFY_LRC_H
...
#define COS_SPOTIFY_LRC_TAIL_MS   4000u

/** 单条歌词最大字节数(含中文,UTF-8 下 1 汉字 3 字节)。 */
#define COS_SPOTIFY_LRC_LINE_MAX  192

typedef struct cos_spotify_lrc_s cos_spotify_lrc_t;
