 ...
 */
#ifndef COS_SPOTIFY_UAC_H
#define COS_SPOTIFY_UAC_H
...
{
    COS_SPOTIFY_OK = 0,
    COS_SPOTIFY_ERR_NO_DIR = 1,      /* /sdcard/spotify missing                 */
    COS_SPOTIFY_ERR_USB_BUSY = 2,    /* USB port occupied by debug console      */
    COS_SPOTIFY_ERR_NO_EARPHONE = 3, /* No UAC device enumerated (charging only)*/
    COS_SPOTIFY_ERR_NOT_AUDIO = 4,   /* Enumerated USB device is not UAC audio  */
    COS_SPOTIFY_ERR_REMOUNT = 5,     /* Failed to re-mount SD after playback    */
    COS_SPOTIFY_ERR_USB_STACK = 6,   /* Failed to start USB audio stack         */
} cos_spotify_err_t;
