 ...
 * @param user Opaque user data passed to eos_shell_exec.
 */
typedef void (*eos_shell_output_cb_t)(const char *line, void *user);
 ...
 */
typedef void (*eos_shell_reboot_cb_t)(void);
