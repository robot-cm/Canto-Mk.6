...
typedef struct cos_fifo_t cos_fifo_t;
 ...
 * @return cos_fifo_t* Returns FIFO pointer if creation succeeds, otherwise returns NULL
 */
 ...
 *       entries that must not be torn, prefer cos_fifo_write_atomic().
 */
