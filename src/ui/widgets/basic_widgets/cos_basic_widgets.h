/**
 * @file cos_basic_widgets.h
 * @brief Basic widgets
 */

#ifndef COS_BASIC_WIDGETS_H
#define COS_BASIC_WIDGETS_H
...
#define COS_LIST_CONTAINER_HEIGHT 100
#define COS_LIST_OBJ_RADIUS 25
#define COS_LIST_SECTION_PLACEHOLDER_HEIGHT 30
#define COS_LIST_CONTAINER_PAD_ALL 24
#define COS_ITEM_RADIUS 20
...
/**
 * @brief Check if list created by cos_list_create has pending transition animation
...
/**
 * @brief Play dedicated transition animation for cos_list_create list
 ...
 * Returns NULL if creation failed
 */
lv_obj_t *cos_list_add_round_icon_button(lv_obj_t *list, lv_color_t bg_color, const void *icon, const char *txt);
/**
 * @brief Add a button with round icon to list
 *
 * btn{  [icon]  [txt]  }
 ...
 * @return cos_list_slider_t* Returns slider object if created successfully
 *
 * Returns NULL if creation failed
 */
