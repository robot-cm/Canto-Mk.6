 ...
 */
#ifndef EOS_FRAMEWORK_HOME_H
#define EOS_FRAMEWORK_HOME_H
...
typedef struct eos_framework_home {
    ...
    bool  is_circle;
    eos_arclist_view_t *arc;    /**< valid when is_circle (Huawei ArcList) */
    eos_layout_view_t  *grid;   /**< valid when !is_circle && grid mode    */
