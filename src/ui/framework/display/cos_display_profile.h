 ...
 */
#ifndef EOS_DISPLAY_PROFILE_H
#define EOS_DISPLAY_PROFILE_H
...
typedef enum {
    EOS_DISPLAY_SHAPE_CIRCLE = 0,   /**< round panel, layout via polar coords   */
    EOS_DISPLAY_SHAPE_SQUARE,       /**< near-square panel, grid/flex layout     */
    EOS_DISPLAY_SHAPE_RECTANGLE,    /**< tall rectangular panel, grid + expand   */
} eos_display_shape_t;

/** @brief Reference width used by the dp scaling system. */
#define EOS_UI_REF_WIDTH 240.0f
...
typedef struct {
    ...
    float dp_scale;          /**< width / EOS_UI_REF_WIDTH               */
} eos_display_profile_t;
