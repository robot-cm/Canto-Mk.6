...
@brief Auto-generate the CantoMk6 icon definition header from a font file, with optional Unicode range
...
#ifndef CANTOMK6_OS_ICON_H
#define CANTOMK6_OS_ICON_H
