 ...
 *
 * 必须满足:
 *   1. src/config/cos_lvgl_requirements.h 的全部强制项
 ...
 *
 * 依据:third_party/lvgl/lv_conf_template.h + cos_lvgl_requirements.h
 *
 ...
 * buffer 整体字节交换,与板级 flush_cb(cos_dev_display_gc9a01.c)的
 ...
 * 分配失败。渲染缓冲仍走 internal s_flush_buf(cos_dev_display_gc9a01.c)，
 * SPI DMA 路径不受影响。
 * ─────────────────────────────────────────────────────── */
#ifdef ESP_PLATFORM
...
/* 支持 lv_font_conv 生成的压缩字体(cos_font_han_sans_22 等) */
