 ...
 * ════════════════════════════════════════════════════════════════ */
/* 8192 过小:Settings->WiFi 转场时 lv_snapshot 渲染曾栈溢出(TCB 8688/504)。
 * 12288 words = 48KB:internal RAM 预算上限(eos_init 前分配,见 main.c 注释) */
#define BOARD_TASK_UI_STACK      12288  /* LVGL + GC9A01 flush(internal RAM) */
